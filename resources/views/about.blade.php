...
@section('body')
  <div class="grid grid-cols-3">
    ...
    <div class="flex flex-col items-start justify-start space-y-4 px-12 col-span-2">
      ...
      <p class="text-xl">
          I was born in December 2005 in Brazil, and I moved to Portugal in 2019 after completing the 8th grade. In 2020, I started studying as a computer programmer. <br><br>
          Currently, I have already completed internships at two influential companies in Portugal, participated in the Europe Immerse Global Summit in 2022, and I am hired to work at one of the companies where I interned. <br><br>
          For the future, I will finish my final course project, start working at the company, and then I plan to attend university to study computer engineering. <br><br>
      </p>
    </div>
  </div>
  <div class="grid grid-cols-3 gap-4 justify-items-center py-6 [&>a]:grid [&>a]:grid-cols-2 [&>a]:gap-2 [&>a]:w-full [&>a>h4]:flex [&>a>h4]:items-end">
    <a href="https://github.com/AbreuDProgrammer">
      <h4>Github</h4>
    ...
    <a href="https://www.linkedin.com/in/leonardo-abreu-714355246/">
      <h4>Linkedin</h4>
    ...
    <a href="https://www.instagram.com/o.leo.a/">
      <h4>Instagram</h4>
    ...
    <a href="https://www.chess.com/member/oleo2412">
      <h4>Chess</h4>
